...
<form action="index.php" method="post">
    ...
    <div><label for="sujet"> mots de passe : </label> <input type="sujet" id="sujet" name="sujet" placeholder="saisir le sujet de votre message ici"/></div>

    <div><label for="message"> mots de passe : </label> <input type="message" id="message" name="message" placeholder="saisir votre message ici"/></div>
