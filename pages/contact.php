...
<div class="form-style-10">
    <h1> Inscrivez-vous maintenant!<span> Inscrivez-vous et dites nous ce que vous pensez!</span></h1>
    <form>
        ...
        <div class="inner-wrap">
            ...
            <label> Numéro de mobile <input type="text" name="field4" /></label>
        </div>
     ...
     <input type="checkbox" name="field7"./> politique de confidentialité.
     </span>
        </div>
    </form>
</div>
